...
class WalkingTask(object):
    ...
    def calc_reward(self, prev_torque, prev_action, action):
        ...
        reward = dict(foot_frc_score=0.150 * rewards._calc_foot_frc_clock_reward(self, l_frc, r_frc),
                      ...
                      com_vel_error=0.150 * rewards._calc_fwd_vel_reward(self), # Reduced weight
                      ...
                      obstacle_avoidance=0.300 * rewards._calc_obstacle_avoidance_reward(self, self.num_obstacles) # Added new reward
        )
        return reward
    ...
    def done(self):
        ...
        obstacle_collision_flag = self._client.check_obstacle_collisions(self.num_obstacles)
        qpos = self._client.get_qpos()
        terminate_conditions = {"qpos[2]_ll":(qpos[2] < 0.6),
                                "qpos[2]_ul":(qpos[2] > 1.4),
                                "contact_flag":contact_flag,
                                "obstacle_collision":obstacle_collision_flag,
        }
